										...
										<ul id="contents" class="collapse list-group in" role="tabpanel" aria-labelledby="Contents: #executePath#">
											<cfloop query="qResults">
												...
												<cfif qResults.type eq "Dir">
													<li class="list-group-item"><a class="btn btn-primary tb-dir-btn" role="button" href="index.cfm?path=#dirPath#"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>#qResults.name#</li>
												<cfelseif listLast( qresults.name, ".") eq "cfm">
													<li class="list-group-item"><a class="btn btn-primary tb-dir-btn" role="button" href="#executePath & qResults.name#" <cfif !url.cpu>target="_blank"</cfif>><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>#qResults.name#</li>
												<cfelseif listLast( qresults.name, ".") eq "cfc" and qresults.name neq "Application.cfc">
													<li class="list-group-item"><a class="btn btn-primary tb-dir-btn" role="button" href="#executePath & qResults.name#?method=runRemote" <cfif !url.cpu>target="_blank"</cfif>><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>#qResults.name#</li>
												</cfif>
											</cfloop>
										</ul>
									</div>
